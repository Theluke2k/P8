function [X_opt,U_opt,P_trace, sol, charge_control, slacks] = MPC_func(rob_init, kf_init, en_params, tuning, mpc_params, cost_params, n_robots, map_bounds, min_dist, sim_params, verbose_opt, do_warm_start, sol_prev, sc)
%% Parameters
import casadi.*
...
slacks = {sol.value(e_low_slack(:,2)), sol.value(e_high_slack(:,2)), sol.value(b_slack(:,2)), sol.value(slack_dist(:,2))};
